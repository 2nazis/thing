...
import (
	...
	"github.com/capmonster-cloud/go-sdk/capmonster"
	logging "webshare-creator/internal"
)

var (
	Logger     = logging.Logger
	capMonster = capmonster.New("c6e56a39b6bfb543aeaded8cc7a90718")
)
...
func (ws *Webshare) SolveCaptcha() (string, error) {
	for {
		s, err := capMonster.CreateRecaptchaV2TaskProxyLess("https://proxy2.webshare.io/", "6LeHZ6UUAAAAAKat_YS--O2tj_by3gv3r_l03j9d", true)
		if err != nil {
			continue
		}
		solutionStr := s.GRecaptchaResponse
